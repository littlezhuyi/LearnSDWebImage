...
typedef NS_OPTIONS(NSUInteger, SDWebImageOptions) {
    /**
     * By default, when a URL fail to be downloaded, the URL is blacklisted so the library won't keep trying.// 默认情况下。如果一个URL加载失败，会将其加入黑名单，就不会再次尝试重新加载
     * This flag disable this blacklisting.// 这个标识符使这个黑名单无效
     */
